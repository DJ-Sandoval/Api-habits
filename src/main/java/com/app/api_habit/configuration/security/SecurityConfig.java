package com.app.api_habit.configuration.security;

import com.app.api_habit.configuration.filter.JwtTokenValidator;
import com.app.api_habit.service.implementation.UserDetailServiceImpl;
import com.app.api_habit.utils.components.JwtUtils;
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity, AuthenticationProvider authenticationProvider) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(http -> {
                    ...
                    http.requestMatchers(HttpMethod.GET, "/motivation/**").permitAll();
                    ...
                    http.requestMatchers("/api/habits/**").authenticated();
